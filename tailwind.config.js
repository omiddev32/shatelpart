...
module.exports = {
  mode: 'jit',
  content: [
    "./modules/**/templates/**/*.{blade.php,js,vue}",
    "./modules/**/src/Resources/*.php",
    "./modules/**/src/Settings/*.php",
    "./modules/**/src/Tabs/*.php",
    "./modules/**/src/Tabs/**/*.php",
    './app/packages/Nova/**/*.php',
    './app/fields/**/*{js,ts,vue}',
    './templates/**/*{js,vue,blade.php}',
  ...
  theme: {
    ...
    extend: {
      fontFamily: { sans: ['iransans', 'Nunito Sans', ...defaultTheme.fontFamily.sans] },
      fontSize: { xxs: '11px' },
      maxWidth: { xxs: '15rem' },
