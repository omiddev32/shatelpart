...
use Closure;
use Exception;
use App\Payment\Contracts\PurchaseInterface;
use App\Payment\Contracts\RefundInterface;
use App\Payment\Contracts\UnverifiedPaymentsInterface;
use App\Payment\Exceptions\ConfigurationNotFoundException;
use App\Payment\Exceptions\DriverNotFoundException;
use App\Payment\Exceptions\InvalidConfigurationException;
use ReflectionClass;
...
class Gateway
{
    ...
    {
        $this->setGateway(config('gateway.default_gateway'));
    }
