...
use App\Payment\Contracts\{Driver, RefundInterface};
use App\Payment\Exceptions\{
    HttpRequestFailedException, InvalidConfigurationException, PaymentFailedException,
    PurchaseFailedException, RefundFailedException
};
use App\Payment\{Receipt, RedirectionForm};
...
//        return $this->getBaseRestServiceUrl().'generateTransactionDataToSign/';
        return $this->getBaseRestServiceUrl().($this->settings['mode'] == 'NoSign' ? 'generateTokenWithNoSign/' : 'generateTransactionDataToSign/');
    }
