...
namespace App\User\Http\Controllers\Panel;

use App\User\Traits\AuthenticatesUsers;
...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        $this->middleware('guest:admin#admin/dashboards/main')->except('logout');
    }
    ...
    protected function authenticated(Request $request, $user)
    {
        ...
        return $request->wantsJson() && optional($user)->hasPermission('view.dashboard.admin')
            ? new JsonResponse([
