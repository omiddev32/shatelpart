...
class DeliveryType extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = 'App\Product\Entities\DeliveryType';
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make(__("Slug"), 'slug')
                ...
                ->readonly($this->id < 3)
                ->sortable()
                ->creationRules('unique:delivery_types,slug')
                ->updateRules('unique:delivery_types,slug,{{resourceId}}'),
