...
class ProductType extends Resource
{
     ...
     * @var string
     */
    public static $model = 'App\Product\Entities\ProductType';
    ...
    public function authorizedToDelete(Request $request)
    {
        if ($request->user()->hasPermission('delete.' . static::$permission)) {
            return $request->user()->hasPermission('delete.' . static::$permission) && $this->id > 5;
        }
        return false;
    }
    ...
    {
        return $this->statusActions([1, 2, 3, 4, 5]);
    }
}