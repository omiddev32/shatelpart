<template>
  <div id="nova">
    ...
    <!-- Content -->
    <div dusk="content" class="mt-[3.5rem]">
      <div
        class="hidden bg-sidebar h-full overflow-y-auto lg:block lg:fixed left-0 bottom-0 lg:top-[56px] lg:bottom-auto w-[18rem] px-3 py-8"
      >
      ...
      <div class="p-4 md:py-8 md:px-12 lg:ml-[18rem] space-y-8">
