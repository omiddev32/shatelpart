    ...
    >
      <div class="flex items-center justify-end space-x-0 text-gray-400">
        ...
        <Button
          ...
          variant="action"
          :class="{
            'text-yellow-500': resource.reasonForConditionalDeletion != ''
          }"
          :disabled="!resource.authorizedToDelete && resource.reasonForConditionalDeletion == ''"
        />
        ...
        <DeleteResourceModal
          ...
          :reasonForConditionalDeletion="resource.reasonForConditionalDeletion"
