  ...
  computed: {
    ...
    controlWrapperClasses() {
      ...
      return [
        'w-full space-y-2',
        this.field.compact ? '!px-3' : 'px-6',
        this.field.controlWrapperClass != '' ? this.field.controlWrapperClass : '',
        this.field.compact && 'md:!px-4 @md/modal:!px-4',
        this.field.stacked && !this.field.inline && 'md:px-8 @md/modal:px-8',
        !this.field.stacked && !this.field.inline && 'md:px-8 @md/modal:px-8',
        !this.field.stacked && !this.field.inline && !this.field.fullWidth && this.field.controlWrapperClass == '' && 'md:w-3/5 @md/modal:w-3/5',
        this.field.stacked && !this.field.inline && !this.field.fullWidth && this.field.controlWrapperClass == '' && 'md:w-3/5 @md/modal:w-3/5',
      ]
    },
