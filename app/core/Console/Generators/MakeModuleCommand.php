...
class MakeModuleCommand extends Command
{
     ...
     */
    public function __construct(Filesystem $files, ModulesManager $module)
    {
        parent::__construct();
        $this->files = $files;
        $this->module = $module;
    ...
    {
        $stub = $this->files->get(__DIR__ . '/../../Structure/console/' . $file . '.stub');
...
//            'Optimizing module cache...' => 'optimizeModules',
    ...
    protected function generateModule()
    {
        ...
        $source    = app_path('core/Structure/module');
