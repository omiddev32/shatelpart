...
class MakeDashboardCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:module:dashboard     
        {slug : The slug of the module.}
        {name : The name of the dashboard class.}';
     ...
     * @var string
     */
    protected $description = 'Create a new module dashboard class.';
    ...
    public function handle()
    {
        ...
        $this->info("Dashboard {$studlyName} has been created!");
    }
    ...
    {
        return app_path('core/Stubs/dashboard.stub');
    }
