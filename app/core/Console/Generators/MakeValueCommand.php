...
class MakeValueCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:module:value     
     ...
     * @var string
     */
    protected $description = 'Create a new module value metric.';
    ...
    public function handle()
    {
        ...
        $this->info("Value $studlyValue has been created!");
    }
    ...
    {
        return app_path('core/Stubs/value.stub');
    }
