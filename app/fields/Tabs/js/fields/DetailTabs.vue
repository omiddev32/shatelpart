      ...
      <div :class="[panel.showTitle && !panel.showToolbar ? 'mt-3' : '']">
        <div id="tabs">
          <div class="block">
            <nav
              aria-label="Tabs"
              class="isolate flex divide-x divide-gray-200 dark:divide-gray-700 rounded-lg shadow overflow-hidden overflow-auto nova-tabs"
            >
              <a
            ...
            >
              ...
              >
                <component
                  ...
                  class="flex flex-col -mx-6 px-6 py-2 md:py-0 space-y-2 md:space-y-0"
                  :class="{
