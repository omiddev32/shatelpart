...
use App\Fields\SelectPlus\FillStrategy\FillAttributeSyncCallback;
...
class SelectPlus extends Field
{
    ...
    public $component = 'select-plus-field';
    ...
    public function withSelectAll(bool $withSelectAll = true)
    {
    ...
    protected function resolveForRelations($resource)
    {
        ...
        if ($this->indexLabel) {
            ...
            if($this->value) {
                ...
                $this->valueForIndexDisplay = $this->name; // example: "states"
            }
        ...
        $this->value = $this->value ? $this->mapToSelectionValue($this->value) : [];
    }
    ...
    protected function fillAttribute(NovaRequest $request, $requestAttribute, $model, $attribute)
    {
        ...
        return new FillAttributeSyncCallback(
