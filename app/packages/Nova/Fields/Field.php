...
abstract class Field extends FieldElement implements JsonSerializable, Resolvable
{
    ...
    /**
     * Wrapper class in form.
     *
     * @var string
     */
    public $controlWrapperClass = '';
    ...
    /**
     * Set the wrapper class in form.
     *
     * @return $this
     */
    public function controlWrapperClass($classes)
    {
        $this->controlWrapperClass = $classes;
    ...
    public function jsonSerialize(): array
    {
        ...
        return with(app(NovaRequest::class), function ($request) {
            return array_merge([
                ...
                'controlWrapperClass' => $this->controlWrapperClass,
