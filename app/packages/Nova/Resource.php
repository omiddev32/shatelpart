...
abstract class Resource implements ArrayAccess, JsonSerializable, UrlRoutable
{
     ...
     * @var string
     */
    public static $reasonForConditionalDeletion = "";
    ...
    {
        return (string) data_get($this, static::$reasonForConditionalDeletion);
    }
    ...
    public function serializeForIndex(NovaRequest $request, $fields = null)
    {
        ...
        return array_merge($this->serializeWithId($fields ?: $this->indexFields($request)), [
            ...
            'authorizedToDelete' => ! $authorizedToDelete ? (! $this->conditionalDeletion($request) ? true : false) : $authorizedToDelete,
            ...
            'reasonForConditionalDeletion' => ! $this->conditionalDeletion($request) ? $this->reasonForConditionalDeletion() : "",
