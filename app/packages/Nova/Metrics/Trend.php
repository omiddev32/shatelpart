        ...
        switch ($unit) {
            ...
            case 'hour':
                return with(Carbon::createFromFormat('Y-m-d H:00', $result), function ($date) use ($twelveHourTime) {
                    return $twelveHourTime
                            ? $date->format('F').' '.$date->format('j').' - '.$date->format('g:00 A')
                            : $date->format('F').' '.$date->format('j').' - '.$date->format('G:00');
                });
            ...
            default:
                return with(Carbon::createFromFormat('Y-m-d H:i:00', $result), function ($date) use ($twelveHourTime) {
                    return $twelveHourTime
                            ? $date->format('F').' '.$date->format('j').' - '.$date->format('g:i A')
                            : $date->format('F').' '.$date->format('j').' - '.$date->format('G:i');
                });
        }
    }
